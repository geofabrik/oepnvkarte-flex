...
function get_area_type(object)
    ...
    elseif naturaltag == "scrub" or naturaltag == "heath" or naturaltag == "grassland" or naturaltag == "fell" then
        landuse = "bush"
    elseif
        landusetag == "recreation_ground"
        or landusetag == "village_green"
        or landusetag == "allotments"
        or leisuretag == "park"
        or leisuretag == "pitch"
        or leisuretag == "track"
        or leisuretag == "golf_course"
        or leisuretag == "common"
        or leisuretag == "playground"
        or leisuretag == "garden"
    then
        landuse = "park"
    elseif
        naturaltag == "water"
        or naturaltag == "lake"
        or waterwaytag == "riverbank"
        or landusetag == "basin"
        or landusetag == "reservoir"
    then
        landuse = "water"
    elseif
        landusetag == "residential"
        or landusetag == "industrial"
        or landusetag == "commercial"
        or landusetag == "retail"
    then
        landuse = "city"
